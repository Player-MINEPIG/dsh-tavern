...
function WorldBookPanel({ sessionId, close }) {
  ...
  return (0, import_react3.createElement)(
    ...
    (0, import_react3.createElement)(
      ...
      (0, import_react3.createElement)("h2", { className: "dwb-section-title" }, "\u72EC\u7ACB\u4E16\u754C\u4E66"),
      (0, import_react3.createElement)(
        "div",
        ...
        selectionDirty ? (0, import_react3.createElement)("div", { className: "dwb-status", "data-warning": true }, "\u7ED1\u5B9A\u6709\u672A\u4FDD\u5B58\u4FEE\u6539\uFF0C\u5F53\u524D\u52FE\u9009\u5C1A\u672A\u5E94\u7528\u5230\u4F1A\u8BDD\u3002") : (0, import_react3.createElement)("p", { className: "dwb-note" }, "\u9762\u677F\u663E\u793A\u7684\u7ED1\u5B9A\u5DF2\u5E94\u7528\u5230\u5F53\u524D\u4F1A\u8BDD\u3002"),
        (0, import_react3.createElement)(
          "div",
          { className: "dwb-actions" },
          (0, import_react3.createElement)("button", { className: "dwb-button dwb-primary", type: "button", disabled: busy || !sessionId || !selectionDirty, onClick: saveSelection }, selectionDirty ? "\u5E94\u7528\u4F1A\u8BDD\u7ED1\u5B9A\uFF08\u672A\u4FDD\u5B58\uFF09" : "\u5F53\u524D\u7ED1\u5B9A\u5DF2\u5E94\u7528"),
          (0, import_react3.createElement)("button", { className: "dwb-button", type: "button", disabled: busy || !sessionId || selection.length === 0, onClick: () => setSelection([]) }, "\u6E05\u7A7A\u5F85\u5E94\u7528\u9009\u62E9")
        )
      ),
      (0, import_react3.createElement)(Field3, { label: "\u6D4F\u89C8\u72EC\u7ACB\u4E16\u754C\u4E66" }, (0, import_react3.createElement)(
        ...
        ...(catalog2?.worldBooks ?? []).map((item) => (0, import_react3.createElement)("option", { key: item.id, value: item.id }, item.name))
      )),
      draft === null ? null : (0, import_react3.createElement)(
        ...
        (0, import_react3.createElement)("p", { className: "dwb-meta" }, `${entries.length} \u6761 \xB7 \u672A\u77E5\u5B57\u6BB5\u5728\u4FDD\u5B58\u548C\u5BFC\u51FA\u65F6\u7A33\u5B9A\u4FDD\u7559`),
        (0, import_react3.createElement)(
          "div",
          { className: "dwb-actions" },
      ...
      embeddedDraft !== null ? (0, import_react3.createElement)("h2", { className: "dwb-section-title" }, "\u89D2\u8272\u5361\u7ED1\u5B9A\u7684\u4E16\u754C\u4E66") : null,
      ...
      (0, import_react3.createElement)("p", { className: "dwb-note" }, "\u5B9E\u9645\u6FC0\u6D3B\u3001\u6392\u5E8F\u3001\u6982\u7387\u548C\u9884\u7B97\u7531\u5171\u4EAB matcher \u786E\u5B9A\uFF1B\u6700\u7EC8\u6CE8\u5165\u4ECD\u7531 Tavern loader \u7EDF\u4E00\u5B8C\u6210\u3002\u5F53\u524D\u626B\u63CF\u4F1A\u628A\u672C\u6B65\u9AA4 claimed \u8F93\u5165\u4E0E\u6301\u4E45\u5386\u53F2\u7EC4\u5408\u6210\u4E34\u65F6\u4E0A\u4E0B\u6587\uFF0C\u56E0\u6B64\u5355\u6B65\u9AA4\u4F1A\u8BDD\u4E5F\u80FD\u5728\u9996\u6B21\u8BF7\u6C42\u89E6\u53D1\u5173\u952E\u8BCD\u3002")
    )
  );
}
  ...
  return (0, import_react5.createElement)(
    ...
    (0, import_react5.createElement)(
      ...
      record.worldBooks?.length > 0 ? (0, import_react5.createElement)(
        ...
        (0, import_react5.createElement)("div", { className: "dttrace-meta" }, record.activation?.pendingMessageCount > 0 ? `\u5339\u914D\u57FA\u4E8E\u672C\u6B65\u9AA4 assembly \u7684\u4E34\u65F6\u6FC0\u6D3B\u4E0A\u4E0B\u6587\uFF1A\u6301\u4E45\u5386\u53F2 + ${record.activation.includedPendingMessageCount}/${record.activation.pendingMessageCount} \u6761\u672C\u8F6E claimed \u8F93\u5165\uFF1B\u4E0D\u4FDD\u5B58\u8F93\u5165\u6B63\u6587${record.activation.truncated ? "\uFF1B\u626B\u63CF\u8F93\u5165\u5DF2\u6309\u4E0A\u9650\u622A\u65AD" : ""}\u3002` : "\u5339\u914D\u57FA\u4E8E\u672C\u6B65\u9AA4 system assembly \u5F53\u65F6\u53EF\u89C1\u7684\u6301\u4E45\u5316\u4F1A\u8BDD\u5386\u53F2\uFF1B\u6CA1\u6709\u91CD\u590D\u9644\u52A0 pending \u8F93\u5165\u3002"),
