...
Plans describe intent; code and tests show implementation. Archived or older-version material is historical context unless a current decision adopts it. For current acceptance boundaries, see [PLAY_REVIEW.md](../../../../docs/PLAY_REVIEW.md) and [TRACE_REVIEW.md](../../../../docs/TRACE_REVIEW.md). Current-facing documents describe the current implementation in place; use matching Git tags for older documentation and CHANGELOG for version history.
