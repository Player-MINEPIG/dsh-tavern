...
The maintained security line is `2.4.x`. DSH compatibility depends on the specific release; consult its README and installation guide. Fixes ship only as new patch versions. Development branches and older releases are not promised separate backports.
