  ...
  return h('div', { className: 'dtu-panel' },
    ...
    h('div', { className: 'dtu-body' },
      h('div', { className: 'dtu-toolbar' },
        ...
        h('a', { className: 'dtu-button', 'data-disabled': draft === null || busy ? true : undefined, 'aria-disabled': draft === null || busy ? true : undefined, href: draft === null || busy ? undefined : `${API_ROOT}/users/${encodeURIComponent(draft.id)}/export`, download: '' }, uiMessage('common.exportJson')),
