export default Object.freeze({
  ...
  "diagnostics.timelineSummary": "⚠ {count} 个周目有问题 · 查看详情",
  ...
  "diagnostics.workspaceSummary": "⚠ 工作区检查失败 · 查看详情",
  ...
  "play.import.lastQa": "外部导入记录 · 最后一轮",
  ...
  "trace.v3.part": "{index}. {name} · {count} 字",
  ...
  "trace.roundAttempt": "轮次 {turn} · 步骤 {step} · 请求记录 {attempt}",
