export default Object.freeze({
  ...
  "diagnostics.timelineSummary": "⚠ {count} playthroughs with problems · Details",
  ...
  "diagnostics.workspaceSummary": "⚠ Workspace check failed · Details",
  ...
  "trace.v3.part": "{index}. {name} · {count} characters",
  ...
  "trace.roundAttempt": "Turn {turn} · Step {step} · Request record {attempt}",
