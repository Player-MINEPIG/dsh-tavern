  ...
  return h('div', { className: 'dtt-root' },
    ...
    h('div', { className: 'dtt-body' },
      ...
      draft === null ? h('p', { className: 'dtt-note' }, catalog === null ? uiMessage('preset.loading') : uiMessage('preset.emptyHint')) : h('div', { className: 'dtt-section' },
        ...
        draft.sampling.reasoningEffort && !['off', 'low', 'medium', 'high', 'xhigh', 'max'].includes(draft.sampling.reasoningEffort)
          ? h('option', { value: draft.sampling.reasoningEffort }, rawText(draft.sampling.reasoningEffort)) : null,
