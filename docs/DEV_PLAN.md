...
Current workspace: `2.2.0` (released 2026-09-11), a DSH compatibility update with additive public API support. See [the migration guide](DSH_0.1.5_MIGRATION_en.md) for scope and verification. The completed `2.1.0` ledger below remains historical.
