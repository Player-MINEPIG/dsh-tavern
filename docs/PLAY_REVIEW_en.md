...
4. Release gate: `npm run verify:2.0` already includes build and pack dry-run. Recheck dependency audit, public-path/secret scan, official docs, and version; promote `2.1.0-rc.1` to the final `2.1.0` tag only after candidate acceptance passes.
