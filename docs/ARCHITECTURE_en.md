...
Status: 2026-09-05. The full DSH compatibility baseline is `0.1.2-rc.1`; install identity is `pmp-dsh-tavern`. HTTP mounts at `/pmp-dsh-tavern/api`; resources use `/v1`; the play-surface contract uses `/v2`. This page is current architecture decisions and release-review gates, not a product README.
